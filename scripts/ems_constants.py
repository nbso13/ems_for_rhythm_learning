...
rhythm_strings = [to_the_beat_substr, clave_substr, five_to_four_substr, three_to_four_substr,  \
    syncopated_substr, bass_drum_pattern, flip_the_beat]
rhythm_strings_names = ["to_the_beat", "clave", "five_to_four", "three_to_four", \
    "syncopated_substr", "bass_drum_pattern", "flip_the_beat"]
bpms_ordered = [95, 100, 105, 110, 115, 120, 125] #bpms to try
bpms = [105, 90, 115, 120, 95, 100, 110] # shuffled
...
worksheet_data_begin_indices = [6, 0] # where empty data space begins in each worksheet
verbose_mode = 1